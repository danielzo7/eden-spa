...
/*
  ======================================================
  --- INÍCIO DA MODIFICAÇÃO: Nova Função (ADICIONADA) ---
  Função que abre o modal de localização ao carregar.
  ======================================================
*/
/**
 * NOVA FUNÇÃO: Abre o modal de localização e contato
 * automaticamente ao carregar a página.
 */
/* <-- CORREÇÃO APLICADA (INÍCIO DO BLOCO COMENTADO)
function abrirModalLocalizacaoAoCarregar() {
    // 1. Encontra o card pelo ID que definimos no HTML
    const card = document.getElementById('location-card');
    
    // 2. Pega os elementos do modal (que já existem na home)
    const overlay = document.getElementById('modal-overlay');
    const modal = document.getElementById('modal-view');
    ...
    // Usamos innerHTML hier por causa dos 'quadrados' em HTML
...
*/ // <-- CORREÇÃO APLICADA (FIM DO BLOCO COMENTADO)
// --- FIM DA MODIFICAÇÃO ---
